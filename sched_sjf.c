...
static struct task_struct *pick_next_task_weighted_rr(struct rq *rq)
{
	...
	struct weighted_rr_rq *sjf_smallest;
	...
	// for weighted_rr
	/*
	next->se.exec_start	= rq->clock;//update next beginning time of process 
	return next;
	*/
	// ...
...
static void task_tick_weighted_rr(struct rq *rq, struct task_struct *p,int queued)
{
	...
	*/
	...
	curr->task_time_slice=curr->weighted_time_slice;
	set_tsk_need_resched(curr);
	requeue_task_weighted_rr(rq,curr);
	// ...
	*/
	return;	
}
